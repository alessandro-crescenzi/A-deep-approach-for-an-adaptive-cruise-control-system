...
CITYSCAPES_CLASSES = ("person", "bicycle", "car", "motorcycle",
                      "rider", "bus", "train", "truck",
                      "traffic sign", "traffic light")

cityscapes_coarse_dataset = dataset_base.copy({
    'name': 'Cityscapes_Coarse',

    # Training images and annotations
    'train_images': './data/cityscapes/images/train_extra',
    'train_info': './data/cityscapes/annotations/instancesonly_filtered_gtCoarse_train.json',

    # Validation images and annotations.
    'valid_images': './data/cityscapes/images/train_extra',
    'valid_info': './data/cityscapes/annotations/instancesonly_filtered_gtCoarse_train.json',

    'class_names': CITYSCAPES_CLASSES,
})

cityscapes_fine_dataset = dataset_base.copy({
    'name': 'Cityscapes_Fine',
...
cityscapes_test_dataset = dataset_base.copy({
...
yolact_base_config = coco_base_config.copy({
    ...
    'num_classes': len(cityscapes_fine_dataset.class_names) + 1,
